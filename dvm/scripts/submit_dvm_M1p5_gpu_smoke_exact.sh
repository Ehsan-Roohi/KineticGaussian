...
if [ -f "/project/pi_roohie_umass_edu/BGK_shock/ref/mach_sweep_extra/M1p5/standing_M1p5_hmom_x35_nx1400_v97_19_19_vmax10_fullstate.npz" ]; then
  echo "[SKIP] final output exists: /project/pi_roohie_umass_edu/BGK_shock/ref/mach_sweep_extra/M1p5/standing_M1p5_hmom_x35_nx1400_v97_19_19_vmax10_fullstate.npz"
  exit 0
fi
